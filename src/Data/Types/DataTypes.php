...
class DataTypes{
    ...
    public static  $DATA_JSON      = "json";  
    public static  $DATA_XML       = "xml";       
    public static  $DATA_HTML      = "html";
    public static  $DATA_CSV       = "csv";
    public static  $DATA_PDF       = "pdf";
    public static  $DATA_DOC         = "doc";    
    public static  $DATA_EXCEL       = "xls";
    public static  $DATA_POWERPOINT  = "ppt";    
}
