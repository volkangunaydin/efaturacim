...
class XmlToArray
{
  /**
     ...
     */
    public static function xmlStringToArray(string $xmlString, bool $useNamespacesOnKeys = false): array
    {
        ...
        if($root!=null){
            $output[$key] = self::domNodeToArray($root, $useNamespacesOnKeys);
        }        
        return $output;
    }
     ...
     */
    private static function domNodeToArray(DOMNode $node, bool $useNamespacesOnKeys)
    {
        $output = [];
